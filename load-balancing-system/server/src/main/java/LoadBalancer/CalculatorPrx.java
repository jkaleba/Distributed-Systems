...
public interface CalculatorPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> multiplyAsync(int a, int b)
    {
        return _iceI_multiplyAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> multiplyAsync(int a, int b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_multiplyAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "multiply", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_a);
                     ostr.writeInt(iceP_b);
                 }, istr -> {
